...
> ## 8-21
> * 昨晚另一轮训练的结果：
> > batch_size 50 num_epochs 10 训练长度为300-800米的路段 其余都是default取值 #8-21 9：12 具体在8-21文件夹内
> > ![8-21调大batch_size](dataFile/pics/8-21.png)
> * 增加了embedding层的网络训练测试都可以了，下午做一下实验看看结果怎么样，