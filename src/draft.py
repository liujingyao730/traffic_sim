...
prefix = train.test("data_basicLSTM_123456", conf.args, [1])
dp.resultBoxplot(prefix)
prefix = train.test("data_basicLSTM_123456", conf.args, [2])
dp.resultBoxplot(prefix)
prefix = train.test("data_basicLSTM_123456", conf.args, [3])
dp.resultBoxplot(prefix)
prefix = train.test("data_basicLSTM_123456", conf.args, [4])
dp.resultBoxplot(prefix)
prefix = train.test("data_basicLSTM_123456", conf.args, [5])
dp.resultBoxplot(prefix)
prefix = train.test("data_basicLSTM_123456", conf.args, [6])
dp.resultBoxplot(prefix)
prefix = train.test("data_basicLSTM_123456", conf.args, [1,2,3,4,5])
dp.resultBoxplot(prefix)
prefix = train.test("data_basicLSTM_123456", conf.args, [1,2,3,4,5,6])
dp.resultBoxplot(prefix)

prefix = train.test("data_basicLSTM_12345", conf.args, [6])
dp.resultBoxplot(prefix)
prefix = train.test("data_basicLSTM_12345", conf.args, [5])
dp.resultBoxplot(prefix)
prefix = train.test("data_basicLSTM_12345", conf.args, [4])
dp.resultBoxplot(prefix)
prefix = train.test("data_basicLSTM_12345", conf.args, [3])
dp.resultBoxplot(prefix)
prefix = train.test("data_basicLSTM_12345", conf.args, [2])
dp.resultBoxplot(prefix)
prefix = train.test("data_basicLSTM_12345", conf.args, [1])
dp.resultBoxplot(prefix)
prefix = train.test("data_basicLSTM_12345", conf.args, [1,2,3,4,5])
dp.resultBoxplot(prefix)
'''
